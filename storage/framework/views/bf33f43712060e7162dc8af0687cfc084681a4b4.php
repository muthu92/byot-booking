...
<body>
	<div id="booking" class="section">
		...
		<?php endif; ?>
						<form name="customer" id="customer" method="post" action="<?php echo e(url('/customer/submit')); ?>" 	>
						 <?php echo csrf_field(); ?>
							<div class="row">
								<div class="col-sm-6">
...
<?php /**PATH D:\xampp7\htdocs\byot-booking\app\Modules/Customer/Views/customer.blade.php ENDPATH**/ ?>