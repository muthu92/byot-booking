...
<div class="row">
        <div class="col">
          ...
          <td><span class="status"><?php echo e($key+1); ?></span></td>
                    <td>                     
                      <span class="status"><?php echo e($vehicle->name); ?></span>
                    </td>
					
					 
					 <td>                     
                      <span class="status"><?php if($vehicle->status==0||$vehicle->status==1): ?> Active <?php else: ?> In Active <?php endif; ?></span>
                    </td>
                    ...
                    <td class="text-right">
                      <div class="dropdown">
                        ...
                        <div class="dropdown-menu dropdown-menu-right dropdown-menu-arrow">
                          <a class="dropdown-item" href="vehicletype/vehicletype_edit?vehicletype_id=<?php echo e($vehicle->id); ?>">Edit</a>
						  <a class="dropdown-item" href="vehicletype/delete?id=<?php echo e($vehicle->id); ?>">Delete</a> 
            ...
            <div class="card-footer py-4">
              <?php echo e($vehicletype_list->links()); ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp7\htdocs\byot-booking\app\Modules/Vehicletype/Views/vehicletype.blade.php ENDPATH**/ ?>