        ...
        <div class="col">
         <div class="col-xl-12 order-xl-1">
          <div class="card">
            ...
            <div class="card-body">
             <form role="form"  method="post" action="<?php echo e(url('/users/submit')); ?>">
                 <?php echo csrf_field(); ?>
                <div class="pl-lg-4">
                  <div class="row">
                    <div class="col-lg-4">
					...
					<div class="col-lg-4" id="vehiclelist" style="display:none">
                      <div class="form-group">
                        ...
                        <select name="vehicle_id" id="vehicle_id" class="form-control" >
						 ...
						 <option value="<?php echo e($vehicle->id); ?>" ><?php echo e($vehicle->vehicle_name); ?></option>
						 <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
						 </select>
                      </div>
                    </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp7\htdocs\byot-booking\app\Modules/Users/Views/users_add.blade.php ENDPATH**/ ?>