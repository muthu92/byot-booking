...
<?php elseif(str_contains(Request::fullUrl(), 'jobs')): ?>
      ...
      <div class="navbar-inner">
        ...
        <div class="collapse navbar-collapse" id="sidenav-collapse-main">
          ...
          <ul class="navbar-nav">
            ...
            <li class="nav-item">
              <a class="nav-link <?php echo $jobs_class; ?>" href="<?php echo e(url('jobs')); ?>">
                <i class="ni ni-tv-2 text-primary"></i>
...
.customSwalBtn{
  ...
  <script>
	...
	$.ajax({
	type: 'POST',
	url: "<?php echo e(url('/jobs/accept_auto')); ?>",
	data: {booking_id: data.booking_id,_token: "<?php echo e(csrf_token()); ?>"},
	dataType: 'JSON',
...
<?php $__env->stopSection(); ?><?php /**PATH D:\xampp7\htdocs\byot-booking\resources\views/layouts/navigation_job.blade.php ENDPATH**/ ?>